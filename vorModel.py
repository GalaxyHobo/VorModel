...
# AS BUILT TAIL:
    ...
    'sRefHTailInFt2': 0.293,
    'arHTail': 2.55,
    'taperHTailInDecimal': 0.89,
    'hTailIncidenceInDeg': 6, # Positive = TE UP on RIGHT SIDE
#  
# OLD TAIL
#    'isHTailOn': 1, # 0 = off, 1 = collective deflection, -1 = asymmetric deflection
#    'sRefHTailInFt2': 0.3,
...
fin.write(' 97.50\n')
fin.write(' 100.00\n')
fin.write('*CAMBER	ROOT - NACA 23112 w/ REFLEX\n')
fin.write(' 0.0000\n')
fin.write(' 0.4669\n')
fin.write(' 1.0344\n')
fin.write(' 1.6701\n')
...
fin.write(' 0.0093\n')
fin.write(' 0.0000\n')
fin.write('*CAMBER	TIP - NACA 23112 w/ REFLEX\n')
fin.write(' 0.0000\n')
fin.write(' 0.4669\n')
fin.write(' 1.0344\n')
fin.write(' 1.6701\n')
...
if inputGeo['isHTailOn'] != 0:  
    ...
    fin.write("{:10.3f}".format(xRootHTailInIn) +
              "{:10.3f}".format(ySta4InIn) +
              "{:10.3f}".format(0 + inputGeo['zElevOffset']) +
    ...
    fin.write("{:10.3f}".format(xRootHTailInIn + xTipHTailInIn) +
              ...
              "{:10.3f}".format(zTipHTailInIn + inputGeo['zElevOffset']) +
